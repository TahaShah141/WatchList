...
export default function NowPlayingMoviesScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-black">
      <Text className="text-white text-3xl font-bold text-center my-4">Now Playing Movies</Text>
      <FlatList
        data={movies}
