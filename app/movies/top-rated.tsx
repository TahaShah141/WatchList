...
export default function TopRatedMoviesScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-black">
      <Text className="text-white text-3xl font-bold text-center my-4">Top Rated Movies</Text>
      <FlatList
        data={movies}
